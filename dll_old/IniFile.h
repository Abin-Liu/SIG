...
public:
	...
	int GetPathName(LPTSTR lpBuffer, DWORD nLength) const; // Retrieve current file name

	//------------------------------------------------------------
	//    Retrieve data from ini file
	//------------------------------------------------------------
	DWORD GetProfileString(LPCTSTR lpSection, LPCTSTR lpEntry, LPCTSTR lpDefault, LPTSTR lpBuffer, DWORD nLength) const;
	...
	BOOL AppendProfileString(LPCTSTR Section, LPCTSTR lpEntry, LPCTSTR LPTSTRing) const;
	BOOL IncreaseProfileInt(LPCTSTR lpSection, LPCTSTR lpEntry, int nIncrease = 1) const;

	//------------------------------------------------------------
	//    List all sections/entries of the ini file
	//------------------------------------------------------------
	DWORD GetProfileSectionNames(LPTSTR lpBuffer, DWORD nLength, char cDelimiter = _T('\0')) const;
	DWORD GetProfileSection(LPCTSTR lpSection, LPTSTR lpBuffer, DWORD nLength, char cDelimiter =_T('\0')) const;
...
protected:
	...
	static BOOL FindEntry(LPCTSTR lpEntry, LPCTSTR LPTSTRing);
	static BOOL IsEntry(LPCTSTR LPTSTRing, LPTSTR lpParsedResult);
	static BOOL FindSection(LPCTSTR lpSection, LPCTSTR LPTSTRing);
	static BOOL IsSection(LPCTSTR LPTSTRing, LPTSTR lpSection);
