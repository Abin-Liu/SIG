...
BOOL CMsgSender::MouseMove(int x, int y)
{
	if (m_hTarget == NULL)
		return FALSE;
...
BOOL CMsgSender::LeftClick(int x, int y)
{
...
BOOL CMsgSender::RightClick(int x, int y)
{
	return (MouseMove(x, y)
...
BOOL CMsgSender::SendString(LPCTSTR lpString)
{
...
BOOL CMsgSender::SendChar(TCHAR ch)
{
	if (m_hTarget == NULL)
		return FALSE;
...
BOOL CMsgSender::LDblClick(int x, int y)
{
	if (m_hTarget == NULL)
		return FALSE;
...
BOOL CMsgSender::SendSysKey(int nKeyCode)
{
	if (m_hTarget == NULL)
		return FALSE;
